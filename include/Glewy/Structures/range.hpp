#ifndef GLEWY_RANGE_HPP
#define GLEWY_RANGE_HPP
...
typedef gly_float gly_midpoint;
...
public:
    ...
    virtual gly_midpoint GetMidpoint() const = 0;
}; 
...
public:
    ...
    virtual gly_midpoint GetMidpoint() const override {return (gly_midpoint)((val.x+val.y)*0.5f);}
};

template<class T>
class MidpointRange : Range<T> {
protected:
    gly_midpoint midpoint;
    T span;
    virtual gly_midpoint GetHalfSpan() const {return ((gly_midpoint)span)*0.5;}
...
public:
    virtual void SetEndPoints(const vec2<T>& end_points) override {
        ...
        midpoint = (gly_midpoint)(end_p.x+end_p.y)*0.5;
    }
...
public:
    ...
    virtual void SetEndPoints(const vec2<T>& end_points) override {
        ...
        span = ep.y-ep.x;
        midpoint = ((gly_midpoint)(ep.x+ep.y))*0.5;
    }
